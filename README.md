...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/devil-dice-recomp/total)](https://github.com/Alexbeav/devil-dice-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/devil-dice-recomp/latest/total)](https://github.com/Alexbeav/devil-dice-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/devil-dice-recomp)](https://github.com/Alexbeav/devil-dice-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Devil Dice** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SCES-01312 disc image
...
|---|---|
| Region | Europe |
| Disc serial | SCES-01312 |
| Discs | 1 |
| Supported dump | Redump `Devil Dice (Europe) (En,Fr,De,Es,It).cue` as CUE/BIN or CHD |
| BIOS | SCPH-5552 (Europe), 524288 bytes, SHA-256 `1faaa18fa820a0225e488d9f086296b8e6c46df739666093987ff7d8fd352c09` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/devil-dice-recomp/releases)
   and extract it into a writable folder.
2. Start `Devil_Dice` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Devil_Dice.exe` and start the game as
usual, or run `Devil_Dice.exe --diagnostic`. Reproduce the problem, quit, then
run `Devil_Dice.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
