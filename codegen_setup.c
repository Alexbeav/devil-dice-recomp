...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Devil Dice",
    .project_root_env = "DEVIL_DICE_PROJECT_ROOT",
    .build_dir_env = "DEVIL_DICE_BUILD_DIR",
    .force_setup_env = "DEVIL_DICE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_013.12_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Devil_Dice",
    .prepare_note =
